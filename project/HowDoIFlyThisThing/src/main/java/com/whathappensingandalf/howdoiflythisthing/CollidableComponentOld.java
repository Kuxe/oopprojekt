 ...
 *
 */
public class CollidableComponentOld implements ICollidableComponent{
	 ...
	 * @param height
	 */
	public CollidableComponentOld(Point2f position, Vector2f direction, int width, int height){
